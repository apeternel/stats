...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UploadSetting.report_view_data'
        db.delete_column('app_uploadsetting', 'report_view_data')

        # Adding field 'UploadSetting.report_view_date'
        db.add_column('app_uploadsetting', 'report_view_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UploadSetting.report_view_data'
        db.add_column('app_uploadsetting', 'report_view_data', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Deleting field 'UploadSetting.report_view_date'
        db.delete_column('app_uploadsetting', 'report_view_date')


    models = {
        'app.allowedtemplate': {
            'Meta': {'object_name': 'AllowedTemplate'},
            ...
            'template_type': ('django.db.models.fields.SmallIntegerField', [], {'default': '2'})
        },
        'app.companytype': {
        ...
        'app.uploadsetting': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report_view_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
