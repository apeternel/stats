...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Transaction.annual'
        db.delete_column('app_transaction', 'annual')

        # Adding field 'Transaction.price'
        db.add_column('app_transaction', 'price', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Transaction.annual'
        db.add_column('app_transaction', 'annual', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Transaction.price'
        db.delete_column('app_transaction', 'price')
