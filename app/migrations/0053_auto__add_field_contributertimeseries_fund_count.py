...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContributerTimeSeries.fund_count'
        db.add_column('app_contributertimeseries', 'fund_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ContributerTimeSeries.fund_count'
        db.delete_column('app_contributertimeseries', 'fund_count')
