...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AssetClassTimeSeries.type'
        db.delete_column('app_assetclasstimeseries', 'type_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'AssetClassTimeSeries.type'
        db.add_column('app_assetclasstimeseries', 'type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.TimeSeriesType']), keep_default=False)
