...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fund.sales_fee'
        db.add_column('app_fund', 'sales_fee', self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fund.sales_fee'
        db.delete_column('app_fund', 'sales_fee')
