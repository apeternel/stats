...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AllowedTemplate'
        db.create_table('app_allowedtemplate', (
            ...
            ('template_type', self.gf('django.db.models.fields.SmallIntegerField')(default=2)),
        ))
        db.send_create_signal('app', ['AllowedTemplate'])


    def backwards(self, orm):
        
        # Deleting model 'AllowedTemplate'
        db.delete_table('app_allowedtemplate')
