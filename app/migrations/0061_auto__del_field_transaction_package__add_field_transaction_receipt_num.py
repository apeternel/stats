...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Transaction.package'
        db.delete_column('app_transaction', 'package_id')

        # Adding field 'Transaction.receipt_number'
        db.add_column('app_transaction', 'receipt_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'Transaction.page_code'
        db.add_column('app_transaction', 'page_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding M2M table for field packages on 'Transaction'
        db.create_table('app_transaction_packages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transaction', models.ForeignKey(orm['app.transaction'], null=False)),
            ('package', models.ForeignKey(orm['app.package'], null=False))
        ))
        db.create_unique('app_transaction_packages', ['transaction_id', 'package_id'])


    def backwards(self, orm):
        
        # Adding field 'Transaction.package'
        db.add_column('app_transaction', 'package', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.Package']), keep_default=False)

        # Deleting field 'Transaction.receipt_number'
        db.delete_column('app_transaction', 'receipt_number')

        # Deleting field 'Transaction.page_code'
        db.delete_column('app_transaction', 'page_code')

        # Removing M2M table for field packages on 'Transaction'
        db.delete_table('app_transaction_packages')
