...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TimeSeriesType'
        db.create_table('app_timeseriestype', (
        ...
        db.send_create_signal('app', ['TimeSeriesType'])

        # Adding model 'AssetClassTimeSeries'
        db.create_table('app_assetclasstimeseries', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.TimeSeriesType'])),
        ...
        # Deleting field 'UserProfile.logged_in'
        db.delete_column('app_userprofile', 'logged_in')


    def backwards(self, orm):
        
        # Deleting model 'TimeSeriesType'
        db.delete_table('app_timeseriestype')

        # Deleting model 'AssetClassTimeSeries'
        db.delete_table('app_assetclasstimeseries')

        # Adding field 'UserProfile.logged_in'
        db.add_column('app_userprofile', 'logged_in', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        'app.assetclasstimeseries': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.TimeSeriesType']"}),
        ...
        'app.timeseriestype': {
            'Meta': {'object_name': 'TimeSeriesType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
