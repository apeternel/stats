...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field reports on 'Package'
        db.create_table('app_package_reports', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('package', models.ForeignKey(orm['app.package'], null=False)),
            ('reports', models.ForeignKey(orm['app.reports'], null=False))
        ))
        db.create_unique('app_package_reports', ['package_id', 'reports_id'])

        # Deleting field 'Reports.package'
        db.delete_column('app_reports', 'package_id')


    def backwards(self, orm):
        
        # Removing M2M table for field reports on 'Package'
        db.delete_table('app_package_reports')

        # Adding field 'Reports.package'
        db.add_column('app_reports', 'package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Package'], null=True, blank=True), keep_default=False)
