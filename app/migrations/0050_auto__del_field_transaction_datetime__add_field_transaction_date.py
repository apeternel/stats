...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Transaction.datetime'
        db.delete_column('app_transaction', 'datetime')

        # Adding field 'Transaction.date'
        db.add_column('app_transaction', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2011, 12, 1), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Transaction.datetime'
        db.add_column('app_transaction', 'datetime', self.gf('django.db.models.fields.DateTimeField')(default=None), keep_default=False)

        # Deleting field 'Transaction.date'
        db.delete_column('app_transaction', 'date')
