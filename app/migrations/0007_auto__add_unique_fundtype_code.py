...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FundType', fields ['code']
        db.create_unique('app_fundtype', ['code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FundType', fields ['code']
        db.delete_unique('app_fundtype', ['code'])
