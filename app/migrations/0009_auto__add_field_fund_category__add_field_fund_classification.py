...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fund.category'
        db.add_column('app_fund', 'category', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.FundCategory'], null=True), keep_default=False)

        # Adding field 'Fund.classification'
        db.add_column('app_fund', 'classification', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.FundClassification'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fund.category'
        db.delete_column('app_fund', 'category_id')

        # Deleting field 'Fund.classification'
        db.delete_column('app_fund', 'classification_id')
