...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InvestmentType.company'
        db.add_column('app_investmenttype', 'company', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InvestmentType.company'
        db.delete_column('app_investmenttype', 'company')
