...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Contributer.user'
        db.delete_column('app_contributer', 'user_id')

        # Adding M2M table for field users on 'Contributer'
        db.create_table('app_contributer_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contributer', models.ForeignKey(orm['app.contributer'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('app_contributer_users', ['contributer_id', 'user_id'])


    def backwards(self, orm):
        
        # Adding field 'Contributer.user'
        db.add_column('app_contributer', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field users on 'Contributer'
        db.delete_table('app_contributer_users')
