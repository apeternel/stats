...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fund.investment_type'
        db.add_column('app_fund', 'investment_type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.InvestmentType'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fund.investment_type'
        db.delete_column('app_fund', 'investment_type_id')
