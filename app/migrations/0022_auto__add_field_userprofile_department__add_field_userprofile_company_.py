...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_userprofile', 'department', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'UserProfile.company'
        db.add_column('app_userprofile', 'company', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'UserProfile.position'
        db.add_column('app_userprofile', 'position', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'UserProfile.phone'
        db.add_column('app_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=11, blank=True), keep_default=False)

        # Adding field 'UserProfile.extension'
        db.add_column('app_userprofile', 'extension', self.gf('django.db.models.fields.CharField')(default='', max_length=8, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.department'
        db.delete_column('app_userprofile', 'department')

        # Deleting field 'UserProfile.company'
        db.delete_column('app_userprofile', 'company')

        # Deleting field 'UserProfile.position'
        db.delete_column('app_userprofile', 'position')

        # Deleting field 'UserProfile.phone'
        db.delete_column('app_userprofile', 'phone')

        # Deleting field 'UserProfile.extension'
        db.delete_column('app_userprofile', 'extension')
