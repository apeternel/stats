...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InvestmentType'
        db.create_table('app_investmenttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('fund_of_fund', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('app', ['InvestmentType'])


    def backwards(self, orm):
        
        # Deleting model 'InvestmentType'
        db.delete_table('app_investmenttype')
