...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_reports', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('file_type', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Package'], null=True, blank=True)),
        ))
        db.send_create_signal('app', ['Reports'])


    def backwards(self, orm):
        
        # Deleting model 'Reports'
        db.delete_table('app_reports')
