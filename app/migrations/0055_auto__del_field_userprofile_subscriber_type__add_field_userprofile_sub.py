...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.subscriber_type'
        db.delete_column('app_userprofile', 'subscriber_type')

        # Adding field 'UserProfile.subscriber'
        db.add_column('app_userprofile', 'subscriber', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.contributer'
        db.add_column('app_userprofile', 'contributer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.suppressed'
        db.add_column('app_userprofile', 'suppressed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserProfile.subscriber_type'
        db.add_column('app_userprofile', 'subscriber_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'UserProfile.subscriber'
        db.delete_column('app_userprofile', 'subscriber')

        # Deleting field 'UserProfile.contributer'
        db.delete_column('app_userprofile', 'contributer')

        # Deleting field 'UserProfile.suppressed'
        db.delete_column('app_userprofile', 'suppressed')
    ...
    models = {
        ...
        'app.package': {
            ...
            'class_file': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'per_file': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'price': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'view': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'})
        },
        'app.reports': {
