...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CIFSCCategoryTimeSeries.fund_category'
        db.add_column('app_cifsccategorytimeseries', 'fund_category', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.FundCategory']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CIFSCCategoryTimeSeries.fund_type'
        db.add_column('app_cifsccategorytimeseries', 'fund_type', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['app.FundType']), keep_default=False)

        # Deleting field 'CIFSCCategoryTimeSeries.fund_category'
        db.delete_column('app_cifsccategorytimeseries', 'fund_category_id')
