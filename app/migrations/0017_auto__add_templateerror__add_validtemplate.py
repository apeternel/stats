...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TemplateError'
        db.create_table('app_templateerror', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('valid_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.ValidTemplate'])),
            ('error', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('template', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('app', ['TemplateError'])

        # Adding model 'ValidTemplate'
        db.create_table('app_validtemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contributer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Contributer'])),
            ('template_one', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('template_two', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('template_three', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('app', ['ValidTemplate'])


    def backwards(self, orm):
        
        # Deleting model 'TemplateError'
        db.delete_table('app_templateerror')

        # Deleting model 'ValidTemplate'
        db.delete_table('app_validtemplate')
