...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InvestmentType.can_own'
        db.add_column('app_investmenttype', 'can_own', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.InvestmentType'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InvestmentType.can_own'
        db.delete_column('app_investmenttype', 'can_own_id')
