...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.page_code'
        db.alter_column('app_transaction', 'page_code', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))


    def backwards(self, orm):
        
        # Changing field 'Transaction.page_code'
        db.alter_column('app_transaction', 'page_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))
    ...
    models = {
        ...
        'app.transaction': {
            ...
            'page_code': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
