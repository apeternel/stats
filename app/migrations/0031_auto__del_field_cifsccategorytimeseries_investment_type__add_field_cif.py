...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CIFSCCategoryTimeSeries.investment_type'
        db.delete_column('app_cifsccategorytimeseries', 'investment_type_id')

        # Adding field 'CIFSCCategoryTimeSeries.fund_type'
        db.add_column('app_cifsccategorytimeseries', 'fund_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app.FundType']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CIFSCCategoryTimeSeries.investment_type'
        db.add_column('app_cifsccategorytimeseries', 'investment_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app.InvestmentType']), keep_default=False)

        # Deleting field 'CIFSCCategoryTimeSeries.fund_type'
        db.delete_column('app_cifsccategorytimeseries', 'fund_type_id')
