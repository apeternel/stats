...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IFICStatisticalCommentary'
        db.create_table('app_ificstatisticalcommentary', (
        ...
        db.send_create_signal('app', ['IFICStatisticalCommentary'])


    def backwards(self, orm):
        
        # Deleting model 'IFICStatisticalCommentary'
        db.delete_table('app_ificstatisticalcommentary')
    ...
    models = {
        ...
        'app.ificstatisticalcommentary': {
            'Meta': {'object_name': 'IFICStatisticalCommentary'},
            'capital_gains': ('django.db.models.fields.FloatField', [], {}),
            'cash': ('django.db.models.fields.FloatField', [], {}),
            'contributer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.Contributer']"}),
            'date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
