...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TemplateError.error_type'
        db.add_column('app_templateerror', 'error_type', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'TemplateError.column'
        db.add_column('app_templateerror', 'column', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'TemplateError.row'
        db.add_column('app_templateerror', 'row', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TemplateError.error_type'
        db.delete_column('app_templateerror', 'error_type')

        # Deleting field 'TemplateError.column'
        db.delete_column('app_templateerror', 'column')

        # Deleting field 'TemplateError.row'
        db.delete_column('app_templateerror', 'row')
