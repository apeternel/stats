...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.permission'
        db.delete_column('app_userprofile', 'permission')

        # Adding field 'UserProfile.member'
        db.add_column('app_userprofile', 'member', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Package'
        db.delete_table('app_package')

        # Deleting model 'Transaction'
        db.delete_table('app_transaction')

        # Adding field 'UserProfile.permission'
        db.add_column('app_userprofile', 'permission', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'UserProfile.member'
        db.delete_column('app_userprofile', 'member')
