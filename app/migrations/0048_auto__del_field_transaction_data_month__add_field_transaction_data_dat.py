...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.data_date'
        db.add_column('app_transaction', 'data_date', self.gf('django.db.models.fields.DateField')(default=None, auto_now_add=True, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Transaction.data_date'
        db.delete_column('app_transaction', 'data_date')
