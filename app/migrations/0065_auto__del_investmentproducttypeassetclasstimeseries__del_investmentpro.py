...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'InvestmentProductTypeAssetClassTimeSeries'
        db.delete_table('app_investmentproducttypeassetclasstimeseries')

        # Deleting model 'InvestmentProductTypeContributerTimeSeries'
        db.delete_table('app_investmentproducttypecontributertimeseries')

        # Deleting model 'InvestmentProductTypeTimeSeries'
        db.delete_table('app_investmentproducttypetimeseries')

        # Deleting model 'IndexTimeSeries'
        db.delete_table('app_indextimeseries')

        # Deleting model 'InvestmentProductTypeCIFSCTimeSeries'
        db.delete_table('app_investmentproducttypecifsctimeseries')

        # Deleting model 'StructureTimeSeries'
        db.delete_table('app_structuretimeseries')

        # Deleting model 'ContributerTimeSeries'
        db.delete_table('app_contributertimeseries')

        # Deleting model 'AssetClassTimeSeries'
        db.delete_table('app_assetclasstimeseries')

        # Deleting model 'CIFSCCategoryTimeSeries'
        db.delete_table('app_cifsccategorytimeseries')

        # Deleting model 'FundTimeSeries'
        db.delete_table('app_fundtimeseries')

        # Adding model 'UploadSetting'
        db.create_table('app_uploadsetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('upload_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('stop_upload_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('app', ['UploadSetting'])


    def backwards(self, orm):
        
        # Adding model 'InvestmentProductTypeAssetClassTimeSeries'
        db.create_table('app_investmentproducttypeassetclasstimeseries', (
            ...
            ('asset_class', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.FundType'])),
            ...
            ('investment_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.InvestmentType'])),
        ...
        db.send_create_signal('app', ['InvestmentProductTypeAssetClassTimeSeries'])

        # Adding model 'InvestmentProductTypeContributerTimeSeries'
        db.create_table('app_investmentproducttypecontributertimeseries', (
            ('transfers_out', self.gf('django.db.models.fields.FloatField')()),
            ('sales_exec', self.gf('django.db.models.fields.FloatField')()),
            ('unit_holder_accounts', self.gf('django.db.models.fields.FloatField')()),
            ('capital_gains', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('app', ['InvestmentProductTypeContributerTimeSeries'])

        # Adding model 'InvestmentProductTypeTimeSeries'
        db.create_table('app_investmentproducttypetimeseries', (
            ('transfers_out', self.gf('django.db.models.fields.FloatField')()),
            ('sales_exec', self.gf('django.db.models.fields.FloatField')()),
            ('unit_holder_accounts', self.gf('django.db.models.fields.FloatField')()),
            ('capital_gains', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('app', ['InvestmentProductTypeTimeSeries'])

        # Adding model 'IndexTimeSeries'
        db.create_table('app_indextimeseries', (
            ('transfers_out', self.gf('django.db.models.fields.FloatField')()),
            ('index', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('unit_holder_accounts', self.gf('django.db.models.fields.FloatField')()),
            ('capital_gains', self.gf('django.db.models.fields.FloatField')()),
            ('net_new_money', self.gf('django.db.models.fields.FloatField')()),
            ('cash', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('app', ['IndexTimeSeries'])

        # Adding model 'InvestmentProductTypeCIFSCTimeSeries'
        db.create_table('app_investmentproducttypecifsctimeseries', (
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.FundCategory'])),
            ('sales_exec', self.gf('django.db.models.fields.FloatField')()),
            ('unit_holder_accounts', self.gf('django.db.models.fields.FloatField')()),
            ('capital_gains', self.gf('django.db.models.fields.FloatField')()),
            ('net_new_money', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('app', ['InvestmentProductTypeCIFSCTimeSeries'])
        ...
        # Adding model 'ContributerTimeSeries'
        db.create_table('app_contributertimeseries', (
            ('transfers_out', self.gf('django.db.models.fields.FloatField')()),
            ('long_term_sales', self.gf('django.db.models.fields.FloatField')()),
            ('unit_holder_accounts', self.gf('django.db.models.fields.FloatField')()),
            ('capital_gains', self.gf('django.db.models.fields.FloatField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reinvested_distribution', self.gf('django.db.models.fields.FloatField')()),
            ('money_market_sales', self.gf('django.db.models.fields.FloatField')()),
            ('cash', self.gf('django.db.models.fields.FloatField')()),
            ('transfers_in', self.gf('django.db.models.fields.FloatField')()),
            ('fund_count', self.gf('django.db.models.fields.IntegerField')()),
            ('other_income', self.gf('django.db.models.fields.FloatField')()),
            ...
            ('gross_sales', self.gf('django.db.models.fields.FloatField')()),
            ('net_new_money', self.gf('django.db.models.fields.FloatField')()),
            ('view', self.gf('django.db.models.fields.CharField')(max_length=3)),
        ))
        db.send_create_signal('app', ['ContributerTimeSeries'])

        # Adding model 'AssetClassTimeSeries'
        db.create_table('app_assetclasstimeseries', (
            ('transfers_out', self.gf('django.db.models.fields.FloatField')()),
            ('unit_holder_accounts', self.gf('django.db.models.fields.FloatField')()),
            ('asset_class', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.FundType'])),
            ('capital_gains', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('app', ['AssetClassTimeSeries'])

        # Adding model 'CIFSCCategoryTimeSeries'
        db.create_table('app_cifsccategorytimeseries', (
            ('transfers_out', self.gf('django.db.models.fields.FloatField')()),
            ('fund_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.FundCategory'])),
            ('unit_holder_accounts', self.gf('django.db.models.fields.FloatField')()),
            ('capital_gains', self.gf('django.db.models.fields.FloatField')()),
            ('net_new_money', self.gf('django.db.models.fields.FloatField')()),
            ('cash', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('app', ['CIFSCCategoryTimeSeries'])

        # Adding model 'FundTimeSeries'
        db.create_table('app_fundtimeseries', (
            ('transfers_out', self.gf('django.db.models.fields.FloatField')()),
            ('other_income', self.gf('django.db.models.fields.FloatField')()),
            ('unit_holder_accounts', self.gf('django.db.models.fields.FloatField')()),
            ('capital_gains', self.gf('django.db.models.fields.FloatField')()),
            ...
            ('transfers_in', self.gf('django.db.models.fields.FloatField')()),
            ('net_assets', self.gf('django.db.models.fields.FloatField')()),
            ('fund', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Fund'])),
            ('sales_exec', self.gf('django.db.models.fields.FloatField')()),
            ('gross_redemptions', self.gf('django.db.models.fields.FloatField')()),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('gross_sales', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('app', ['FundTimeSeries'])

        # Deleting model 'UploadSetting'
        db.delete_table('app_uploadsetting')
    ...
    models = {
        ...
        'app.transaction': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'packages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['app.Package']", 'symmetrical': 'False'}),
            'page_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
