...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Package.monthly'
        db.add_column('app_package', 'monthly', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Package.quarterly'
        db.add_column('app_package', 'quarterly', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Removing M2M table for field reports on 'Transaction'
        db.delete_table('app_transaction_reports')


    def backwards(self, orm):
        
        # Deleting field 'Package.monthly'
        db.delete_column('app_package', 'monthly')

        # Deleting field 'Package.quarterly'
        db.delete_column('app_package', 'quarterly')

        # Adding M2M table for field reports on 'Transaction'
        db.create_table('app_transaction_reports', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transaction', models.ForeignKey(orm['app.transaction'], null=False)),
            ('reports', models.ForeignKey(orm['app.reports'], null=False))
        ))
        db.create_unique('app_transaction_reports', ['transaction_id', 'reports_id'])
