...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.data_month'
        db.add_column('app_transaction', 'data_month', self.gf('django.db.models.fields.DateField')(default=None, auto_now_add=True, null=True, blank=True), keep_default=False)

        # Deleting field 'Package.annual_price'
        db.delete_column('app_package', 'annual_price')

        # Deleting field 'Package.per_file_price'
        db.delete_column('app_package', 'per_file_price')

        # Adding field 'Package.price'
        db.add_column('app_package', 'price', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Transaction.data_month'
        db.delete_column('app_transaction', 'data_month')

        # Adding field 'Package.annual_price'
        db.add_column('app_package', 'annual_price', self.gf('django.db.models.fields.FloatField')(default=None), keep_default=False)

        # Adding field 'Package.per_file_price'
        db.add_column('app_package', 'per_file_price', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True), keep_default=False)

        # Deleting field 'Package.price'
        db.delete_column('app_package', 'price')
    ...
    models = {
        ...
        'app.transaction': {
            ...
            'data_month': ('django.db.models.fields.DateField', [], {'default': 'None', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'app.userprofile': {
            ...
            'subscriber_type': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
