...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contributer.hide'
        db.add_column('app_contributer', 'hide', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contributer.hide'
        db.delete_column('app_contributer', 'hide')
