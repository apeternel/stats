...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Package.time_series'
        db.add_column('app_package', 'time_series', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Package.time_series'
        db.delete_column('app_package', 'time_series')
    ...
    models = {
        ...
        'app.package': {
            ...
            'time_series': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
