...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FundCategory', fields ['code']
        db.create_unique('app_fundcategory', ['code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FundCategory', fields ['code']
        db.delete_unique('app_fundcategory', ['code'])
