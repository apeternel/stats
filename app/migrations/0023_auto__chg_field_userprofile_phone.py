...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('app_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=14))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.phone'
        db.alter_column('app_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=11))
