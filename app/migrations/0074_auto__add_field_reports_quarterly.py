...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reports.quarterly'
        db.add_column('app_reports', 'quarterly', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reports.quarterly'
        db.delete_column('app_reports', 'quarterly')
