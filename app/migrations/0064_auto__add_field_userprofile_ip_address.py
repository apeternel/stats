...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.ip_address'
        db.add_column('app_userprofile', 'ip_address', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.ip_address'
        db.delete_column('app_userprofile', 'ip_address')
