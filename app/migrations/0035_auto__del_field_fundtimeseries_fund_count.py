...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FundTimeSeries.fund_count'
        db.delete_column('app_fundtimeseries', 'fund_count')


    def backwards(self, orm):
        
        # Adding field 'FundTimeSeries.fund_count'
        db.add_column('app_fundtimeseries', 'fund_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
