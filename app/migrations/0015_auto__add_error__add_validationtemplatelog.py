...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'app.error': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'validation_log': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.ValidationTemplateLog']"})
        },
        'app.fund': {
        ...
        'app.validationtemplatelog': {
            'Meta': {'object_name': 'ValidationTemplateLog'},
            'contributer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.Contributer']"}),
